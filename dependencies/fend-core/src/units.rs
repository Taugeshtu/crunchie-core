...
pub use builtin::IMPLICIT_UNIT_MAP;
pub use builtin::lookup_default_unit;
...
pub fn query_unit_static<I: Interrupt>(
	ident: &str,
	attrs: Attrs,
	context: &mut crate::Context,
	int: &I,
...
pub fn get_completions_for_prefix(prefix: &str) -> Vec<crate::Completion> {
