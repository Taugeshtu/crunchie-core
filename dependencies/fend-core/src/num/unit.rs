...
impl Value {
	...
	pub fn try_as_usize_unit<I: Interrupt>(self, int: &I) -> FResult<usize> {
		if !self.exact {
	...
	pub fn div<I: Interrupt>(self, rhs: Self, int: &I) -> FResult<Self> {
	...
	pub fn combination<I: Interrupt>(
		self,
		rhs: Self,
		decimal_separator: DecimalSeparatorStyle,
		int: &I,
	...
	pub fn permutation<I: Interrupt>(
		self,
		rhs: Self,
		decimal_separator: DecimalSeparatorStyle,
		int: &I,
	...
	pub fn is_unitless<I: Interrupt>(&self, int: &I) -> FResult<bool> {
	...
	pub fn is_unitless_one<I: Interrupt>(&self, int: &I) -> FResult<bool> {
	...
	pub fn abs<I: Interrupt>(self, int: &I) -> FResult<Self> {
	...
	pub fn is_zero<I: Interrupt>(&self, int: &I) -> FResult<bool> {
		self.value.equals_int(0, int)
	}

	pub fn new_die<I: Interrupt>(count: u32, faces: u32, int: &I) -> FResult<Self> {
	...
	pub fn into_unitless_complex<I: Interrupt>(
		mut self,
		decimal_separator: DecimalSeparatorStyle,
		int: &I,
	) -> FResult<Complex> {
	...
	pub fn sample<I: Interrupt>(self, ctx: &mut crate::Context, int: &I) -> FResult<Self> {
		Ok(Self {
	...
	pub fn mean<I: Interrupt>(self, int: &I) -> FResult<Self> {
		Ok(Self {
	...
	pub fn floor<I: Interrupt>(self, int: &I) -> FResult<Self> {
	...
	pub fn ceil<I: Interrupt>(self, int: &I) -> FResult<Self> {
	...
	pub fn round<I: Interrupt>(self, int: &I) -> FResult<Self> {
	...
	pub fn conjugate(self) -> FResult<Self> {
		Ok(Self {
	...
	pub fn asin<I: Interrupt>(self, context: &mut crate::Context, int: &I) -> FResult<Self> {
		self.apply_fn(Complex::asin, false, context.decimal_separator, int)
	}

	pub fn acos<I: Interrupt>(self, context: &mut crate::Context, int: &I) -> FResult<Self> {
		self.apply_fn(Complex::acos, false, context.decimal_separator, int)
	}

	pub fn atan<I: Interrupt>(self, context: &mut crate::Context, int: &I) -> FResult<Self> {
		self.apply_fn(Complex::atan, false, context.decimal_separator, int)
	}

	pub fn sinh<I: Interrupt>(self, context: &mut crate::Context, int: &I) -> FResult<Self> {
		self.apply_fn(Complex::sinh, false, context.decimal_separator, int)
	}

	pub fn cosh<I: Interrupt>(self, context: &mut crate::Context, int: &I) -> FResult<Self> {
		self.apply_fn(Complex::cosh, false, context.decimal_separator, int)
	}

	pub fn tanh<I: Interrupt>(self, context: &mut crate::Context, int: &I) -> FResult<Self> {
		self.apply_fn(Complex::tanh, false, context.decimal_separator, int)
	}

	pub fn asinh<I: Interrupt>(
		self,
		context: &mut crate::Context,
		int: &I,
	) -> FResult<Self> {
	...
	pub fn ln<I: Interrupt>(self, context: &mut crate::Context, int: &I) -> FResult<Self> {
		self.apply_fn_exact(Complex::ln, true, context.decimal_separator, int)
	}

	pub fn log2<I: Interrupt>(self, context: &mut crate::Context, int: &I) -> FResult<Self> {
		self.apply_fn(Complex::log2, true, context.decimal_separator, int)
	}

	pub fn log10<I: Interrupt>(
		self,
		context: &mut crate::Context,
		int: &I,
	) -> FResult<Self> {
	...
	pub fn mul<I: Interrupt>(self, rhs: Self, int: &I) -> FResult<Self> {
	...
	pub fn unit_equal_to<I: Interrupt>(&self, rhs: &str, int: &I) -> FResult<bool> {
...
impl FormattedValue {
	pub fn spans(self, spans: &mut Vec<Span>, attrs: Attrs) {
...
impl Unit {
	...
	pub fn equal_to<I: Interrupt>(&self, rhs: &str, int: &I) -> FResult<bool> {
