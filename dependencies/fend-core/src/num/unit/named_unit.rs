...
pub fn compare_hashmaps<I: Interrupt>(
...
impl NamedUnit {
	...
	pub fn compare<I: Interrupt>(&self, other: &Self, int: &I) -> FResult<bool> {
	...
	pub fn new_from_base(base_unit: BaseUnit) -> Self {
		Self {
			prefix: "".into(),
	...
	pub fn prefix_and_name(&self, plural: bool) -> (&str, &str) {
		(
			self.prefix.as_ref(),
			if plural {
	...
	pub fn has_no_base_units(&self) -> bool {
	...
	pub fn print_with_space(&self) -> bool {
