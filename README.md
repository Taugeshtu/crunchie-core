...
Capability niche: **python/spreadsheet** > [fend](https://github.com/printfn/fend)/[numbat](https://github.com/sharkdp/numbat) > _**Crunchie**_ > **calculator app**
...
_More details in the **[Vision](./docs/Vision.md)** doc. And also I just fancied writing a parser._
...
# 2. Strict Physics
x = 5cm + 3     // Poisoned! Cannot mix dimensioned and unitless.
y_tho = 5kg + 10m   // Poisoned! Cannot add mass and length.

# 3. Assertions (Errors if not mathematically true)
10m + 50cm = 10.5m

# 4. Queries (The engine calculates and auto-fills)
area = PI * radius^2
